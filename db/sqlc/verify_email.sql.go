...
INSERT INTO "verify_emails" ("username", "email", "secret_code")
    VALUES ($1, $2, $3) RETURNING id, username, email, secret_code, is_used, expires_at, created_at
`
...
UPDATE "verify_emails" SET is_used = TRUE
    ...
    RETURNING id, username, email, secret_code, is_used, expires_at, created_at
`
